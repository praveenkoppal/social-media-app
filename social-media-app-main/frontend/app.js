// Default to same-origin API when served locally. Use `window.__API_URL__` to
// override in production builds if needed.
const defaultAPI = (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') ? '' : 'https://social-media-app-teal-phi.vercel.app';
const baseURL = window.__API_URL__ || defaultAPI;
