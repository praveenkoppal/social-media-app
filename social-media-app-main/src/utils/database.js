...
const initializePool = () => {
  if (!pool) {
    // Prefer a full connection string if provided (e.g. Neon DATABASE_URL)
    if (process.env.DATABASE_URL) {
      pool = new Pool({
        connectionString: process.env.DATABASE_URL,
        // Allow self-signed / proxied certs used by some hosted DB providers
      ...
      pool = new Pool({
        ...
        // 🔴 REQUIRED for Railway/Neon public proxies
        ssl: {
